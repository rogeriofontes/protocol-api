...
import br.com.unipac.protocoloapi.exception.UserException;
import br.com.unipac.protocoloapi.exception.UserNotFoundException;
...
public class ResourceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> userNotFoundException(final UserNotFoundException ex) {
        ErrorMessage errorMessage = createErrorMessage(ex.getMessage());
        return new ResponseEntity<>(errorMessage, HttpStatus.NOT_FOUND);
    }
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public ResponseEntity<ErrorMessage> UserException(final UserException ex) {
        ErrorMessage errorMessage = createErrorMessage(ex.getMessage());
        return new ResponseEntity<>(errorMessage, HttpStatus.NOT_FOUND);
    }
